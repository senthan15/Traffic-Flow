-- Insert sample profiles (these will link to existing auth users or create placeholder ones)
...
INSERT INTO public.likes (id, user_id, post_id, created_at) VALUES
  ('like-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'post-2222-2222-2222-222222222222', NOW() - INTERVAL '18 hours'),
  ('like-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'post-1111-1111-1111-111111111111', NOW() - INTERVAL '1 day 18 hours'),
  ('like-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'post-2222-2222-2222-222222222222', NOW() - INTERVAL '19 hours'),
  ('like-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'post-3333-3333-3333-333333333333', NOW() - INTERVAL '8 hours'),
  ('like-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'post-4444-4444-4444-444444444444', NOW() - INTERVAL '4 hours'),
  ('like-6666-6666-6666-666666666666', '22222222-2222-2222-2222-222222222222', 'post-5555-5555-5555-555555555555', NOW() - INTERVAL '2 hours 30 minutes'),
  ('like-7777-7777-7777-777777777777', '33333333-3333-3333-3333-333333333333', 'post-4444-4444-4444-444444444444', NOW() - INTERVAL '3 hours'),
  ('like-8888-8888-8888-888888888888', '44444444-4444-4444-4444-444444444444', 'post-5555-5555-5555-555555555555', NOW() - INTERVAL '1 hour 15 minutes');